      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Mytalorzone By Sahiba</h2>
            <p className="mb-4">Creative, unique, and diverse clothing for girls. Offering traditional, western, and trendy styles that celebrate individuality and fashion.</p>
          ...
          <div>
            ...
            <p className="mb-4">Stay updated with our latest styles and offers.</p>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8 text-center">
          <p>&copy; {new Date().getFullYear()} Mytalorzone By Sahiba. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
